# Consuming ちゅ〜るちゅーぶ デザインシステム in Expo apps

Read `artifacts/churuchubu-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/churuchubu-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/churuchubu-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/churuchubu-design-system/lib/native-theme";
import { useColors } from "@workspace/churuchubu-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/churuchubu-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/churuchubu-design-system/components/native/badge";
import { Button } from "@workspace/churuchubu-design-system/components/native/button";
import { Card } from "@workspace/churuchubu-design-system/components/native/card";
```
...
Import and render
`@workspace/churuchubu-design-system/components/native/button`, then run Expo
