# Consuming ちゅ〜るちゅーぶ デザインシステム in web apps

Read `artifacts/churuchubu-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/churuchubu-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/churuchubu-design-system/styles.css";
```
...
`node_modules/@workspace/churuchubu-design-system/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/churuchubu-design-system/hooks/use-toast";
```
...
`@workspace/churuchubu-design-system/components/ui/button`. Run the app's typecheck
