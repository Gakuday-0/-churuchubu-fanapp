# Migrating web UI to ちゅ〜るちゅーぶ デザインシステム

Read `artifacts/churuchubu-design-system/docs/AGENTS.md` and
`artifacts/churuchubu-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/churuchubu-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/churuchubu-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/churuchubu-design-system/hooks/use-toast`
