...
export const DESIGN_SYSTEM = {
  title: 'ちゅ〜るちゅーぶ Design System',
  description:
    '公認ファンサイトのための、白・黒・グレーを基調にピンクを要所へ絞った共有デザインシステム。',
} as const;
    ...
    entries: [
      {
        id: 'brand-logo',
        name: 'Logo',
        description: 'The supplied ちゅ〜るちゅーぶ wordmark and its quiet supporting treatment.',
        Page: BrandLogoPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        name: 'Hierarchy and tone',
        description: 'Writing and visual hierarchy for a calm, trustworthy fan experience.',
